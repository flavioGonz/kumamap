export const iconSvgPaths: Record<string, string> = {
  ...
  _antenna:   '<path d="M2 12 7 2"/><path d="m7 12 5-10"/><path d="m12 12 5-10"/><path d="m17 12 5-10"/><path d="M4.5 7h15"/><path d="M12 16v6"/>',
  _pole:      '<line x1="12" y1="2" x2="12" y2="22"/><circle cx="12" cy="4" r="2"/>',
