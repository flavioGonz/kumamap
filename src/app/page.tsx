...
function useKumaMonitors() {
  // Seed initial state from cached payload so page doesn't flash "disconnected"
  // when the socket singleton already received monitors before this component mounted.
